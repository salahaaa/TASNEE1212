...
public static class ScreenFactory
{
    ...
    private static UIElement TreatmentScreen()
    {
        var v = new RawTreatmentView();
        var c = new ErpChrome { TitleText = "[MAIN] - [نظام إدارة وتصنيع التمور - معالجة وتعقيم الخام] - (" + Company + ")" };
        v.AttachChrome(c);
        return c;
    }
    ...
    public static UIElement Create(string code) => code switch
    {
        ...
        "avail" => WrapPlain(new CustomerAvailabilityBoardView(), "متاح العملاء", "التسليم والشحن", "MRPDLV1002"),   // §B102.1

        // التقارير
        "reports" => WrapPlain(new ReportsView(), "مركز التقارير الموحد", "التقارير", "MRPRPT1000"),
        "shipment" => WrapPlain(new ShipmentReportView(), "تقرير حركة شحنة العميل", "التقارير", "MRPRPT1011"),   // §B102 (سحب B101)   // الطباعة بزر داخلي في الشاشة
